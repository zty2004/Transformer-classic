...
class LLaMA:
    ...
    def text_completion(self, prompts: list[str], temperature: float = 0.6, top_p: float = 0.9, max_gen_len: Optional[int] = None):
        ...
        for cur_pos in tqdm(range(1, total_len), desc='Generating tokens'):
            ...
            # EOS reached if we found an EOS token for a padding position
        ...
        out_tokens = []
        out_text = []
        for promt_index, current_prompt_tokens in enumerate(tokens.tolist()):
            # Cut to EOS
...
if __name__ == '__main__':
    ...
    prompts = [
        "Tell me who is Tianyou Zuo:",
        "What would happen if AI rules human?"
    ]
